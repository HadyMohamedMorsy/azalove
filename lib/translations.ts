...
export const translations: Record<Locale, Translations> = {
  ar: {
    ...
    returnRefund: {
      ...
      sections: {
        introduction:
          "نحن في أزلــوڤ نسعى لإثراء مكتبتكم بأجمل قصص الحب والرومانسية. توضح سياسة الإرجاع والاسترداد هذه حقوقكم في إرجاع الكتب الرومانسية واسترداد الأموال. نحن ملتزمون بتقديم تجربة قراءة مميزة، ونوفر عملية إرجاع واسترداد سهلة وعادلة لجميع عملائنا من عشاق الأدب الرومانسي.",
        returnPeriod: {
          title: "فترة الإرجاع",
        ...
        returnProcess: {
          ...
          steps: {
            ...
            items: [
              "قم بتسجيل الدخول إلى حسابك في أزلــوڤ",
        ...
        refunds: {
          ...
          methods: {
            ...
            items: [
              ...
              "رصيد في موقع أزلــوڤ للكتب الرومانسية",
        ...
        giftReturns: {
          ...
          items: [
            ...
            "الاسترداد يتم كرصيد في موقع أزلــوڤ",
    ...
    shippingDelivery: {
      ...
      sections: {
        introduction:
          "نحن في أزلــوڤ نسعى لإيصال أجمل قصص الحب والرومانسية إلى باب منزلكم بأسرع وقت ممكن وبأفضل جودة. توضح سياسة الشحن والتوصيل هذه جميع التفاصيل المتعلقة بتوصيل الكتب الرومانسية، من مواعيد الشحن إلى تكاليف التوصيل. نحن ملتزمون بحماية كتبكم أثناء النقل وضمان وصولها في حالة مثالية لتستمتعوا بقراءتها.",
        deliveryAreas: {
          title: "مناطق التوصيل",
          domestic: {
        ...
        tracking: {
          ...
          howToTrack: {
            ...
            steps: [
              "سجل الدخول إلى حسابك في أزلــوڤ",
              'اذهب إلى قسم "طلباتي"',
              "انقر على رقم الطلب",
    ...
    termsAndConditions: {
      ...
      sections: {
        introduction:
          "مرحباً بك في موقع أزلــوڤ للتجارة الإلكترونية. هذه الشروط والأحكام تحكم استخدامك لموقعنا الإلكتروني والخدمات المقدمة من خلاله. باستخدام موقعنا، فإنك توافق على الالتزام بهذه الشروط والأحكام. إذا كنت لا توافق على أي جزء من هذه الشروط، فيرجى عدم استخدام موقعنا.",
        definitions: {
          title: "التعريفات",
          items: {
            website: "الموقع: يشير إلى موقع أزلــوڤ الإلكتروني",
    ...
    termsConditions: {
      ...
      sections: {
        ...
        contactInfo: {
          ...
          companyInfo: {
            companyName: "اسم الشركة: متجر أزلــوڤ للكتب الرومانسية",
        ...
        consentAcknowledgment: {
          ...
          description:
            "باستخدام موقع أزلــوڤ للكتب الرومانسية وتقديم أي طلب شراء، فإنكم تقرون بأنكم قد قرأتم وفهمتم ووافقتم على جميع الشروط والأحكام المذكورة أعلاه. كما تقرون بأنكم تبلغون من العمر 18 عاماً أو أكثر وأنكم تملكون الأهلية القانونية للدخول في هذه الاتفاقية.",
        },
      },
    },
    promoBlock: {
    ...
    cookiePolicy: {
      ...
      sections: {
        introduction: {
          title: "مقدمة",
          content:
            "نحن في أزلــوڤ نسعى لتوفير تجربة قراءة مميزة لعشاق الكتب الرومانسية من خلال موقعنا الإلكتروني. نستخدم ملفات تعريف الارتباط (الكوكيز) لتحسين تجربة التصفح وتخصيص المحتوى وفهم كيفية استخدام موقعنا. توضح هذه السياسة كيفية استخدامنا لملفات تعريف الارتباط وحقوقكم في إدارتها. نحن ملتزمون بحماية خصوصيتكم وشفافية استخدام بياناتكم.",
        },
        whatAreCookies: {
