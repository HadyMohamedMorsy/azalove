...
export const metadata: Metadata = {
  title: "الوثائق القانونية - أزلــوڤ",
  description:
    "الوثائق القانونية الرسمية لشركة أزلــوڤ - عقد التأسيس، الوثائق الضريبية، السجل التجاري، والبطاقة الضريبية",
  keywords: "الوثائق القانونية, أزلــوڤ, عقد التأسيس, الوثائق الضريبية, السجل التجاري, البطاقة الضريبية",
  openGraph: {
    type: "website",
    title: "الوثائق القانونية - أزلــوڤ",
    description:
...
const legalDocuments = [
  {
    id: 1,
    title: "عقد تأسيس شركة أزلــوڤ",
    description:
      "الوثيقة الرسمية لتأسيس شركة أزلــوڤ والتي تتضمن جميع التفاصيل القانونية والإدارية للشركة",
  ...
  },
  {
    ...
    title: "وثيقة الضرائب",
    description:
      "الوثيقة الرسمية للضرائب التي تثبت التزام شركة أزلــوڤ بجميع المتطلبات الضريبية",
  ...
  {
    id: 3,
    title: "سجل شركة أزلــوڤ",
    description:
      "السجل التجاري الرسمي لشركة أزلــوڤ والذي يوثق جميع الأنشطة التجارية للشركة",
  ...
  },
  {
    ...
    description:
      "البطاقة الضريبية الرسمية لشركة أزلــوڤ والتي تثبت التسجيل في النظام الضريبي",
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              جميع الوثائق القانونية الرسمية لشركة أزلــوڤ متاحة للتحميل والاطلاع
            </p>
          </div>
          ...
          <div className="mt-16 bg-white rounded-lg shadow-lg p-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed">
                ...
                هذه الوثائق تثبت الشرعية القانونية لشركة أزلــوڤ والتزامها بجميع المتطلبات القانونية والضريبية.
              </p>
            </div>
          </div>
        </div>
